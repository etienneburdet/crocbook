...
var getNodeRequestOptions = (request2) => {
  ...
  const headers2 = new Headers(request2[INTERNALS].headers);
  ...
  if (module2.load) {
    const load_input = {
      ...
      fetch: async (resource, opts = {}) => {
        ...
        const resolved = resolve(request2.path, url.split("?")[0]);
        let response;
        ...
        if (asset) {
          ...
          if (opts.credentials !== "omit") {
            uses_credentials = true;
            headers2.cookie = request2.headers.cookie;
            if (!headers2.authorization) {
              headers2.authorization = request2.headers.authorization;
            }
          }
    ...
    return await options2.hooks.handle({
      ...
      resolve: async (request3) => {
        ...
        for (const route of options2.manifest.routes) {
          const match = route.pattern.exec(request3.path);
          if (!match)
            continue;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-316066fb.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-316066fb.js", assets + "/_app/chunks/vendor-3e2d2e51.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-ad4025cf.js", "css": [], "js": ["layout.svelte-ad4025cf.js", "chunks/vendor-3e2d2e51.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-3b3b2577.js", "css": [], "js": ["error.svelte-3b3b2577.js", "chunks/vendor-3e2d2e51.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-e613caf3.js", "css": [], "js": ["pages/index.svelte-e613caf3.js", "chunks/vendor-3e2d2e51.js"], "styles": [] } };
...
var API_KEY = "keyvbmmb47rrKDklH";
var headers = new Headers({ Authorization: `Bearer ${API_KEY}` });
var request = new Request("https://api.airtable.com/v0/appGca1zvRwNN4TnZ/Familles", {
  headers
});
...
var airtable = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get
});
...
<button type="${"button"}" name="${"button"}">fetch Airtable</button>`;
});
